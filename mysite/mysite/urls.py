...
from communityinfo.views import register, user_login, home_page, community_creation, join_community, follow_user, search_communities, visit_community # Import your registration view
