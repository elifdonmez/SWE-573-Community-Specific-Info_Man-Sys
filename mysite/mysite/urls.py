...
from communityinfo.views import register, user_login, home_page, community_creation, join_community, follow_user, search_communities  # Import your registration view
